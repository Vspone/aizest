...
name: "DALL-E 3"
slug: "dalle"
description: "OpenAI's most advanced text-to-image generation model with photorealistic output"
category: "image"
...
features:
  ...
  - "High-quality output at 1024x1024 resolution and beyond"
  - "Accurate text rendering within generated images"
  - "Style adaptation from photorealism to illustration and painting"
  - "Seamless integration with ChatGPT for prompt refinement"
  - "Inpainting and outpainting capabilities"
pricing_tiers:
  - name: "ChatGPT Free"
    price: "$0"
    features:
      - "Limited DALL-E 3 generations per day"
      - "Basic image quality"
      - "ChatGPT web and mobile access"
  - name: "ChatGPT Plus"
    price: "$20/mo"
    features:
      - "Extended DALL-E 3 access with faster generation"
  ...
  - name: "Enterprise"
    price: "Custom"
    features:
      - "Unlimited DALL-E 3 generations"
...
cons:
  - "Only available through ChatGPT subscription or API"
  - "Content safety filters can be overly restrictive"
  - "No standalone web app — requires ChatGPT or API"
